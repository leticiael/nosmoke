...
const slides = [
  ...
  },
  {
    ...
    description: "Você tem uma meta de cigarros por dia. Ficar dentro da meta é grátis! Se passar, cada cigarro extra custa 30 XP.",
    image: "/images/cigarroaceso.png",
    bgColor: "from-emerald-950/60 to-slate-900/40",
    details: [
      { icon: "✓", text: "Dentro da meta = Grátis", color: "text-emerald-400" },
      { icon: "!", text: "Cigarro extra = -30 XP", color: "text-amber-400" },
    ],
  },
  {
    id: 3,
    title: "Seu XP (Vida)",
    description: "Você recebe 100 XP de mesada todo dia à meia-noite. Esse é seu 'dinheiro' para gastar em cigarros extras ou trocar por recompensas!",
  ...
  },
  {
    ...
    description: "Clique em 'Pedir', escolha a quantidade e o motivo. A Letícia recebe o pedido e aprova (ou não 😅).",
    ...
    details: [
      ...
      { icon: "3.", text: "Aguarde aprovação", color: "text-zinc-300" },
    ],
  },
  {
    id: 7,
    title: "Pronto para começar?",
    description: "Sua jornada começa agora! Lembre-se: cada cigarro a menos é uma vitória. Você consegue! 💪",
    image: "/images/guerreiro1.png",
    bgColor: "from-teal-950/60 to-slate-900/40",
    isLast: true,
  },
